...
public class CircularCountDownBar extends View {
    ...
    private void setupPaints() {
        ...
        mBackgroundPaint.setColor(getResources().getColor(R.color.rest_background_color));
        mBackgroundPaint.setStrokeCap(mRoundedCorners ? Paint.Cap.ROUND : Paint.Cap.BUTT);
...
//        mSecondPaint.setShadowLayer(5, 5, 5, 0xFF6C6C6C);
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(calcProgressFromSweepAngle(mSweepAngle) + " ", xPos, yPos, mSecondPaint);
    }
